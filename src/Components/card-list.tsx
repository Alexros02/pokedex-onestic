...
/**
 * Tarjeta en formato lista para un Pokémon.
 *
 * - Presenta imagen, nombre, tipos, peso y descripción truncada.
 * - Usa colores de acento derivados de `pokemon.typeColor` para halos y bordes.
 * - Navega al detalle con click, Enter o Space.
 */

/**
 * Props del componente `CardList`.
 */
...
const CardList = ({ pokemon }: CardListProps) => {
  ...
  return (
    ...
    <div
      className="relative overflow-hidden rounded-2xl border border-white/20 bg-white/30 dark:bg-white/5 backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-2xl hover:bg-white/40 dark:hover:bg-white/10 shadow-md cursor-pointer"
      role="button"
      tabIndex={0}
